...
public class NyWebView extends WebView {
    ...
    public NyWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NyWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void setMixedContentAllowed(final WebSettings webSettings, final boolean allowed) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            //TODO
            webSettings.setMixedContentMode(allowed ? WebSettings.LOAD_NORMAL : WebSettings.LOAD_CACHE_ONLY);
        }
    }
    ...
    protected void init(Context context) {
        ...
        //TODO 2022-2-19 add FullScreenVideoWebView functions
        class chromeClientFullScreen extends WebChromeClient {
        ...
        super.setWebChromeClient(new chromeClientFullScreen(context));
